...
Public API:
  get_column_lineage_test(manifest_path: str, source: str, source_column: str, flg: str) -> dict
...
def get_column_lineage_test(manifest_path: str, source: str, source_column: str, flg: str) -> Dict[str, object]:
    """
