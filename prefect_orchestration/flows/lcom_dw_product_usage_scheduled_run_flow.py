...
@flow
def lcom_dw_product_usage_scheduled_run_flow(
    ...
    (
        ...
        partial(
            run_dbt,
            command_name="Product Usage Tests",
            target=Variable.get("target", default="dev"),
            loaddate=loaddate,
        ),
    ),
...
if __name__ == "__main__":
    state = lcom_dw_product_usage_scheduled_run_flow(
        task_dry_runs={
            "Product Usage": DryRun.REAL,
            "Product Usage Tests": DryRun.REAL,
