...
CREATE OR REPLACE PROCEDURE content_delivery_usage.lc_load_students_usage_monthly_snapshots(pmonth_year integer, ploaddate timestamp)
	LANGUAGE plpgsql
AS $$
...
where mon_year=pmonth_year;
      ...
      with
       ...
       fal.user_grade_level_code as grade_level,
...
LOOP
    ...
    from content_delivery_usage.dim_product_category_learning_object_monthly dpclom
