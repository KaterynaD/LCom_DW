...
select
    ...
    table_name,
    total_rows,
    max_fivetran_synced_date,
    count(1) as changed_on_max_fivetran_synced_date
from rawdata.fivetran_salesforce.abn_experiment f
join data_abn_experiment
    on f._fivetran_synced::date = data_abn_experiment.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_abn_experiment_cohort
    on f._fivetran_synced::date = data_abn_experiment_cohort.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_abn_experiment_cohort_attr_val
    on f._fivetran_synced::date = data_abn_experiment_cohort_attr_val.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_abn_experiment_engmt_sgnl_mtrc
    on f._fivetran_synced::date = data_abn_experiment_engmt_sgnl_mtrc.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_account
    on f._fivetran_synced::date = data_account.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_account_brand
    on f._fivetran_synced::date = data_account_brand.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_account_relation_c
    on f._fivetran_synced::date = data_account_relation_c.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_account_relation_history
    on f._fivetran_synced::date = data_account_relation_history.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_activation_target
    on f._fivetran_synced::date = data_activation_target.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_activation_target_feed
    on f._fivetran_synced::date = data_activation_target_feed.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_activation_target_history
    on f._fivetran_synced::date = data_activation_target_history.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_activation_target_platform
    on f._fivetran_synced::date = data_activation_target_platform.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_activation_target_platform_history
    on f._fivetran_synced::date = data_activation_target_platform_history.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_activation_target_secure_ftp
    on f._fivetran_synced::date = data_activation_target_secure_ftp.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_activation_trgt_int_org_access
    on f._fivetran_synced::date = data_activation_trgt_int_org_access.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_activation_trgt_int_org_access_feed
    on f._fivetran_synced::date = data_activation_trgt_int_org_access_feed.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_activation_trgt_int_org_access_history
    on f._fivetran_synced::date = data_activation_trgt_int_org_access_history.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_activity_roll_up_c
    on f._fivetran_synced::date = data_activity_roll_up_c.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_activity_roll_up_history
    on f._fivetran_synced::date = data_activity_roll_up_history.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_actv_tgt_platform_field_value
    on f._fivetran_synced::date = data_actv_tgt_platform_field_value.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_actv_tgt_platform_field_value_history
    on f._fivetran_synced::date = data_actv_tgt_platform_field_value_history.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_agileed_connect_link_data_problem_report_c
    on f._fivetran_synced::date = data_agileed_connect_link_data_problem_report_c.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_agileed_fieldmapping_c
    on f._fivetran_synced::date = data_agileed_fieldmapping_c.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_ai_job_run
    on f._fivetran_synced::date = data_ai_job_run.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_alternative_payment_method
    on f._fivetran_synced::date = data_alternative_payment_method.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_analytics_user_attr_func_tkn
    on f._fivetran_synced::date = data_analytics_user_attr_func_tkn.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_apex_code_coverage_aggregate
    on f._fivetran_synced::date = data_apex_code_coverage_aggregate.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_app_usage_assignment
    on f._fivetran_synced::date = data_app_usage_assignment.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_async_operation_tracker
    on f._fivetran_synced::date = data_async_operation_tracker.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_attribute_definition
    on f._fivetran_synced::date = data_attribute_definition.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_attribute_definition_feed
    on f._fivetran_synced::date = data_attribute_definition_feed.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_attribute_definition_history
    on f._fivetran_synced::date = data_attribute_definition_history.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_attribute_picklist
    on f._fivetran_synced::date = data_attribute_picklist.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_attribute_picklist_feed
    on f._fivetran_synced::date = data_attribute_picklist_feed.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_attribute_picklist_history
    on f._fivetran_synced::date = data_attribute_picklist_history.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_attribute_picklist_value
    on f._fivetran_synced::date = data_attribute_picklist_value.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_attribute_picklist_value_feed
    on f._fivetran_synced::date = data_attribute_picklist_value_feed.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_attribute_picklist_value_history
    on f._fivetran_synced::date = data_attribute_picklist_value_history.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_automation_analytic_c
    on f._fivetran_synced::date = data_automation_analytic_c.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_business_operations_request_c
    on f._fivetran_synced::date = data_business_operations_request_c.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_business_operations_request_feed
    on f._fivetran_synced::date = data_business_operations_request_feed.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_business_operations_request_history
    on f._fivetran_synced::date = data_business_operations_request_history.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_business_ops_request_c
    on f._fivetran_synced::date = data_business_ops_request_c.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_calc_affinity_engmt_sgnl
    on f._fivetran_synced::date = data_calc_affinity_engmt_sgnl.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_calculated_affinity
    on f._fivetran_synced::date = data_calculated_affinity.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_calculated_affinity_field
    on f._fivetran_synced::date = data_calculated_affinity_field.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_calculated_insight_range_bound
    on f._fivetran_synced::date = data_calculated_insight_range_bound.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_campaign
    on f._fivetran_synced::date = data_campaign.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_card_payment_method
    on f._fivetran_synced::date = data_card_payment_method.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_case
    on f._fivetran_synced::date = data_case.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_case_comment
    on f._fivetran_synced::date = data_case_comment.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_case_rel_harmonized_content
    on f._fivetran_synced::date = data_case_rel_harmonized_content.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_case_related_issue
    on f._fivetran_synced::date = data_case_related_issue.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_case_solution
    on f._fivetran_synced::date = data_case_solution.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_chat_report_cr_bot_c
    on f._fivetran_synced::date = data_chat_report_cr_bot_c.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_chat_report_cr_custom_label_c
    on f._fivetran_synced::date = data_chat_report_cr_custom_label_c.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_chat_report_cr_flow_data_c
    on f._fivetran_synced::date = data_chat_report_cr_flow_data_c.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_chat_report_cr_report_type_c
    on f._fivetran_synced::date = data_chat_report_cr_report_type_c.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_chat_report_cr_skill_based_routing_rule_c
    on f._fivetran_synced::date = data_chat_report_cr_skill_based_routing_rule_c.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_codesters_codesters_license_c
    on f._fivetran_synced::date = data_codesters_codesters_license_c.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_codesters_codesters_member_c
    on f._fivetran_synced::date = data_codesters_codesters_member_c.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_codesters_codesters_organization_c
    on f._fivetran_synced::date = data_codesters_codesters_organization_c.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_codesters_codesters_settings_c
    on f._fivetran_synced::date = data_codesters_codesters_settings_c.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_codesters_opportunity_license_c
    on f._fivetran_synced::date = data_codesters_opportunity_license_c.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_contact
    on f._fivetran_synced::date = data_contact.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_contact_center_bulk_op
    on f._fivetran_synced::date = data_contact_center_bulk_op.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_contact_history
    on f._fivetran_synced::date = data_contact_history.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_contract
    on f._fivetran_synced::date = data_contract.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_conversation_api_log
    on f._fivetran_synced::date = data_conversation_api_log.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_conversation_api_log_obj_sum
    on f._fivetran_synced::date = data_conversation_api_log_obj_sum.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_credit_memo
    on f._fivetran_synced::date = data_credit_memo.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_credit_memo_feed
    on f._fivetran_synced::date = data_credit_memo_feed.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_credit_memo_history
    on f._fivetran_synced::date = data_credit_memo_history.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_credit_memo_inv_application
    on f._fivetran_synced::date = data_credit_memo_inv_application.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_credit_memo_inv_application_feed
    on f._fivetran_synced::date = data_credit_memo_inv_application_feed.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_credit_memo_inv_application_history
    on f._fivetran_synced::date = data_credit_memo_inv_application_history.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_credit_memo_line
    on f._fivetran_synced::date = data_credit_memo_line.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_credit_memo_line_feed
    on f._fivetran_synced::date = data_credit_memo_line_feed.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_credit_memo_line_history
    on f._fivetran_synced::date = data_credit_memo_line_history.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_dashboard_component_localization
    on f._fivetran_synced::date = data_dashboard_component_localization.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_dashboard_localization
    on f._fivetran_synced::date = data_dashboard_localization.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_data_assessment_field_metric
    on f._fivetran_synced::date = data_data_assessment_field_metric.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_data_assessment_metric
    on f._fivetran_synced::date = data_data_assessment_metric.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_data_assessment_value_metric
    on f._fivetran_synced::date = data_data_assessment_value_metric.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_data_content_lens_source
    on f._fivetran_synced::date = data_data_content_lens_source.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_data_content_lens_source_feed
    on f._fivetran_synced::date = data_data_content_lens_source_feed.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_data_content_lens_source_history
    on f._fivetran_synced::date = data_data_content_lens_source_history.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_data_harmonized_model_obj_ref
    on f._fivetran_synced::date = data_data_harmonized_model_obj_ref.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_data_knowledge_space
    on f._fivetran_synced::date = data_data_knowledge_space.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_data_knowledge_space_session
    on f._fivetran_synced::date = data_data_knowledge_space_session.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_data_knowledge_src_file_ref
    on f._fivetran_synced::date = data_data_knowledge_src_file_ref.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_data_obj_secondary_index
    on f._fivetran_synced::date = data_data_obj_secondary_index.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_data_obj_secondary_index_feed
    on f._fivetran_synced::date = data_data_obj_secondary_index_feed.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_data_obj_secondary_index_history
    on f._fivetran_synced::date = data_data_obj_secondary_index_history.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_data_quick_attribute
    on f._fivetran_synced::date = data_data_quick_attribute.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_data_quick_attribute_feed
    on f._fivetran_synced::date = data_data_quick_attribute_feed.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_data_quick_attribute_history
    on f._fivetran_synced::date = data_data_quick_attribute_history.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_data_space
    on f._fivetran_synced::date = data_data_space.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_data_space_feed
    on f._fivetran_synced::date = data_data_space_feed.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_data_space_history
    on f._fivetran_synced::date = data_data_space_history.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_digital_wallet
    on f._fivetran_synced::date = data_digital_wallet.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_doc_generation_query_result
    on f._fivetran_synced::date = data_doc_generation_query_result.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_doc_generation_query_result_feed
    on f._fivetran_synced::date = data_doc_generation_query_result_feed.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_doc_generation_query_result_history
    on f._fivetran_synced::date = data_doc_generation_query_result_history.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_document_generation_process
    on f._fivetran_synced::date = data_document_generation_process.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_engagement_signal
    on f._fivetran_synced::date = data_engagement_signal.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_engagement_signal_cmpnd_metric
    on f._fivetran_synced::date = data_engagement_signal_cmpnd_metric.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_engagement_signal_feed
    on f._fivetran_synced::date = data_engagement_signal_feed.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_engagement_signal_history
    on f._fivetran_synced::date = data_engagement_signal_history.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_engagement_signal_metric
    on f._fivetran_synced::date = data_engagement_signal_metric.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_entity_particle
    on f._fivetran_synced::date = data_entity_particle.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_epic_c
    on f._fivetran_synced::date = data_epic_c.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_epic_feed
    on f._fivetran_synced::date = data_epic_feed.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_epic_history
    on f._fivetran_synced::date = data_epic_history.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_fivetran_api_call
    on f._fivetran_synced::date = data_fivetran_api_call.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_fivetran_dependent_picklist_relation
    on f._fivetran_synced::date = data_fivetran_dependent_picklist_relation.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_fivetran_formula
    on f._fivetran_synced::date = data_fivetran_formula.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_fivetran_formula_failure_reason
    on f._fivetran_synced::date = data_fivetran_formula_failure_reason.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_fivetran_formula_model
    on f._fivetran_synced::date = data_fivetran_formula_model.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_fivetran_picklist_field
    on f._fivetran_synced::date = data_fivetran_picklist_field.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_fivetran_picklist_field_value
    on f._fivetran_synced::date = data_fivetran_picklist_field_value.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_fivetran_query
    on f._fivetran_synced::date = data_fivetran_query.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_fivetran_rollup_summary
    on f._fivetran_synced::date = data_fivetran_rollup_summary.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_fivetran_rollup_summary_filter
    on f._fivetran_synced::date = data_fivetran_rollup_summary_filter.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_flow_personal_configuration_c
    on f._fivetran_synced::date = data_flow_personal_configuration_c.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_flow_table_view_definition_c
    on f._fivetran_synced::date = data_flow_table_view_definition_c.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_forecasting_submission
    on f._fivetran_synced::date = data_forecasting_submission.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_forecasting_submission_item
    on f._fivetran_synced::date = data_forecasting_submission_item.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_goal_assignment
    on f._fivetran_synced::date = data_goal_assignment.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_goal_assignment_feed
    on f._fivetran_synced::date = data_goal_assignment_feed.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_goal_assignment_history
    on f._fivetran_synced::date = data_goal_assignment_history.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_goal_assignment_recommendation
    on f._fivetran_synced::date = data_goal_assignment_recommendation.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_goal_definition
    on f._fivetran_synced::date = data_goal_definition.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_goal_definition_feed
    on f._fivetran_synced::date = data_goal_definition_feed.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_goal_definition_history
    on f._fivetran_synced::date = data_goal_definition_history.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_incp_incident_lv_fields_c
    on f._fivetran_synced::date = data_incp_incident_lv_fields_c.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_incp_time_zone_selection_c
    on f._fivetran_synced::date = data_incp_time_zone_selection_c.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_invoice
    on f._fivetran_synced::date = data_invoice.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_invoice_feed
    on f._fivetran_synced::date = data_invoice_feed.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_invoice_history
    on f._fivetran_synced::date = data_invoice_history.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_invoice_line
    on f._fivetran_synced::date = data_invoice_line.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_invoice_line_feed
    on f._fivetran_synced::date = data_invoice_line_feed.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_invoice_line_history
    on f._fivetran_synced::date = data_invoice_line_history.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_lcom_account_c
    on f._fivetran_synced::date = data_lcom_account_c.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_lcom_account_feed
    on f._fivetran_synced::date = data_lcom_account_feed.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_lcom_license_c
    on f._fivetran_synced::date = data_lcom_license_c.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_lcom_license_feed
    on f._fivetran_synced::date = data_lcom_license_feed.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_lcom_license_site_c
    on f._fivetran_synced::date = data_lcom_license_site_c.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_lcom_license_site_feed
    on f._fivetran_synced::date = data_lcom_license_site_feed.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_lcom_member_c
    on f._fivetran_synced::date = data_lcom_member_c.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_lcom_member_feed
    on f._fivetran_synced::date = data_lcom_member_feed.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_lcom_opportunity_site_c
    on f._fivetran_synced::date = data_lcom_opportunity_site_c.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_lcom_opportunity_term_c
    on f._fivetran_synced::date = data_lcom_opportunity_term_c.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_lcom_opportunity_term_feed
    on f._fivetran_synced::date = data_lcom_opportunity_term_feed.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_lcom_opportunity_term_history
    on f._fivetran_synced::date = data_lcom_opportunity_term_history.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_lcom_order_c
    on f._fivetran_synced::date = data_lcom_order_c.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_lcom_order_feed
    on f._fivetran_synced::date = data_lcom_order_feed.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_lcom_order_line_c
    on f._fivetran_synced::date = data_lcom_order_line_c.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_lcom_order_line_feed
    on f._fivetran_synced::date = data_lcom_order_line_feed.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_lcom_order_modification_c
    on f._fivetran_synced::date = data_lcom_order_modification_c.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_lcom_order_modification_feed
    on f._fivetran_synced::date = data_lcom_order_modification_feed.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_lcom_organization_c
    on f._fivetran_synced::date = data_lcom_organization_c.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_lcom_organization_feed
    on f._fivetran_synced::date = data_lcom_organization_feed.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_lcom_suite_c
    on f._fivetran_synced::date = data_lcom_suite_c.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_lcom_suite_feed
    on f._fivetran_synced::date = data_lcom_suite_feed.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_lcom_term_c
    on f._fivetran_synced::date = data_lcom_term_c.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_lcom_term_feed
    on f._fivetran_synced::date = data_lcom_term_feed.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_lead
    on f._fivetran_synced::date = data_lead.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_lead_status_c
    on f._fivetran_synced::date = data_lead_status_c.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_learning_com_c
    on f._fivetran_synced::date = data_learning_com_c.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_learning_com_district_license_c
    on f._fivetran_synced::date = data_learning_com_district_license_c.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_learning_com_district_license_history
    on f._fivetran_synced::date = data_learning_com_district_license_history.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_learning_com_order_c
    on f._fivetran_synced::date = data_learning_com_order_c.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_learning_com_school_license_c
    on f._fivetran_synced::date = data_learning_com_school_license_c.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_learning_com_school_license_history
    on f._fivetran_synced::date = data_learning_com_school_license_history.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_market_segment
    on f._fivetran_synced::date = data_market_segment.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_market_segment_activation
    on f._fivetran_synced::date = data_market_segment_activation.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_market_segment_activation_feed
    on f._fivetran_synced::date = data_market_segment_activation_feed.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_market_segment_activation_history
    on f._fivetran_synced::date = data_market_segment_activation_history.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_market_segment_feed
    on f._fivetran_synced::date = data_market_segment_feed.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_market_segment_history
    on f._fivetran_synced::date = data_market_segment_history.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_mkt_sgmnt_actvtn_aud_attribute
    on f._fivetran_synced::date = data_mkt_sgmnt_actvtn_aud_attribute.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_mkt_sgmnt_actvtn_contact_point
    on f._fivetran_synced::date = data_mkt_sgmnt_actvtn_contact_point.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_mkt_sgmt_actv_contact_pt_field
    on f._fivetran_synced::date = data_mkt_sgmt_actv_contact_pt_field.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_mkt_sgmt_actv_contact_pt_src
    on f._fivetran_synced::date = data_mkt_sgmt_actv_contact_pt_src.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_mkt_sgmt_actv_data_model_fld
    on f._fivetran_synced::date = data_mkt_sgmt_actv_data_model_fld.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_mkt_sgmt_actv_data_source
    on f._fivetran_synced::date = data_mkt_sgmt_actv_data_source.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_ml_intent_utterance_suggestion
    on f._fivetran_synced::date = data_ml_intent_utterance_suggestion.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_mlmodel
    on f._fivetran_synced::date = data_mlmodel.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_mlmodel_factor
    on f._fivetran_synced::date = data_mlmodel_factor.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_mlmodel_factor_component
    on f._fivetran_synced::date = data_mlmodel_factor_component.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_mlmodel_metric
    on f._fivetran_synced::date = data_mlmodel_metric.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_nps_survey_responses_c
    on f._fivetran_synced::date = data_nps_survey_responses_c.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_object_from_email_accepted_fields_c
    on f._fivetran_synced::date = data_object_from_email_accepted_fields_c.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_object_from_email_default_fields_c
    on f._fivetran_synced::date = data_object_from_email_default_fields_c.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_object_milestone_pause_time
    on f._fivetran_synced::date = data_object_milestone_pause_time.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_omni_component_error_log
    on f._fivetran_synced::date = data_omni_component_error_log.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_omni_component_error_log_feed
    on f._fivetran_synced::date = data_omni_component_error_log_feed.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_omni_data_pack
    on f._fivetran_synced::date = data_omni_data_pack.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_omni_data_pack_feed
    on f._fivetran_synced::date = data_omni_data_pack_feed.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_omni_data_transform
    on f._fivetran_synced::date = data_omni_data_transform.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_omni_data_transform_item
    on f._fivetran_synced::date = data_omni_data_transform_item.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_omni_esignature_template
    on f._fivetran_synced::date = data_omni_esignature_template.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_omni_global_auto_number
    on f._fivetran_synced::date = data_omni_global_auto_number.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_omni_global_auto_number_feed
    on f._fivetran_synced::date = data_omni_global_auto_number_feed.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_omni_process
    on f._fivetran_synced::date = data_omni_process.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_omni_process_compilation
    on f._fivetran_synced::date = data_omni_process_compilation.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_omni_process_element
    on f._fivetran_synced::date = data_omni_process_element.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_omni_process_feed
    on f._fivetran_synced::date = data_omni_process_feed.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_omni_process_transient_data
    on f._fivetran_synced::date = data_omni_process_transient_data.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_omni_process_transient_data_feed
    on f._fivetran_synced::date = data_omni_process_transient_data_feed.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_omni_script_saved_session
    on f._fivetran_synced::date = data_omni_script_saved_session.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_omni_script_saved_session_feed
    on f._fivetran_synced::date = data_omni_script_saved_session_feed.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_omni_ui_card
    on f._fivetran_synced::date = data_omni_ui_card.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_omni_ui_card_feed
    on f._fivetran_synced::date = data_omni_ui_card_feed.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_operating_hours
    on f._fivetran_synced::date = data_operating_hours.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_operating_hours_feed
    on f._fivetran_synced::date = data_operating_hours_feed.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_operating_hours_history
    on f._fivetran_synced::date = data_operating_hours_history.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_operating_hours_holiday
    on f._fivetran_synced::date = data_operating_hours_holiday.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_operating_hours_holiday_feed
    on f._fivetran_synced::date = data_operating_hours_holiday_feed.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_operating_hours_holiday_history
    on f._fivetran_synced::date = data_operating_hours_holiday_history.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_opportunity
    on f._fivetran_synced::date = data_opportunity.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_opportunity_line_item
    on f._fivetran_synced::date = data_opportunity_line_item.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_order
    on f._fivetran_synced::date = data_order.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_order_detail_confirmation_c
    on f._fivetran_synced::date = data_order_detail_confirmation_c.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_order_detail_confirmation_history
    on f._fivetran_synced::date = data_order_detail_confirmation_history.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_order_item
    on f._fivetran_synced::date = data_order_item.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_organization
    on f._fivetran_synced::date = data_organization.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_payment
    on f._fivetran_synced::date = data_payment.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_payment_auth_adjustment
    on f._fivetran_synced::date = data_payment_auth_adjustment.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_payment_authorization
    on f._fivetran_synced::date = data_payment_authorization.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_payment_feed
    on f._fivetran_synced::date = data_payment_feed.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_payment_gateway
    on f._fivetran_synced::date = data_payment_gateway.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_payment_gateway_log
    on f._fivetran_synced::date = data_payment_gateway_log.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_payment_group
    on f._fivetran_synced::date = data_payment_group.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_payment_line_invoice
    on f._fivetran_synced::date = data_payment_line_invoice.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_personalization_schema
    on f._fivetran_synced::date = data_personalization_schema.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_pricebook_2
    on f._fivetran_synced::date = data_pricebook_2.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_pricebook_entry
    on f._fivetran_synced::date = data_pricebook_entry.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_product_2
    on f._fivetran_synced::date = data_product_2.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_product_catalog
    on f._fivetran_synced::date = data_product_catalog.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_product_catalog_feed
    on f._fivetran_synced::date = data_product_catalog_feed.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_product_catalog_history
    on f._fivetran_synced::date = data_product_catalog_history.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_product_category
    on f._fivetran_synced::date = data_product_category.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_product_category_feed
    on f._fivetran_synced::date = data_product_category_feed.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_product_category_history
    on f._fivetran_synced::date = data_product_category_history.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_product_category_product
    on f._fivetran_synced::date = data_product_category_product.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_product_category_product_history
    on f._fivetran_synced::date = data_product_category_product_history.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_product_component_group
    on f._fivetran_synced::date = data_product_component_group.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_product_component_group_feed
    on f._fivetran_synced::date = data_product_component_group_feed.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_product_component_group_history
    on f._fivetran_synced::date = data_product_component_group_history.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_product_config_flow_assignment
    on f._fivetran_synced::date = data_product_config_flow_assignment.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_product_configuration_flow
    on f._fivetran_synced::date = data_product_configuration_flow.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_product_configuration_flow_feed
    on f._fivetran_synced::date = data_product_configuration_flow_feed.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_product_configuration_flow_history
    on f._fivetran_synced::date = data_product_configuration_flow_history.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_product_related_component
    on f._fivetran_synced::date = data_product_related_component.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_product_relationship_type
    on f._fivetran_synced::date = data_product_relationship_type.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_product_selling_model
    on f._fivetran_synced::date = data_product_selling_model.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_product_selling_model_feed
    on f._fivetran_synced::date = data_product_selling_model_feed.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_product_selling_model_history
    on f._fivetran_synced::date = data_product_selling_model_history.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_product_selling_model_option
    on f._fivetran_synced::date = data_product_selling_model_option.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_profile
    on f._fivetran_synced::date = data_profile.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_prompt_action
    on f._fivetran_synced::date = data_prompt_action.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_prompt_error
    on f._fivetran_synced::date = data_prompt_error.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_proration_policy
    on f._fivetran_synced::date = data_proration_policy.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_rcsfl_admin_setting_c
    on f._fivetran_synced::date = data_rcsfl_admin_setting_c.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_rcsfl_ai_notes_c
    on f._fivetran_synced::date = data_rcsfl_ai_notes_c.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_rcsfl_ring_central_webinar_token_c
    on f._fivetran_synced::date = data_rcsfl_ring_central_webinar_token_c.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_record_type
    on f._fivetran_synced::date = data_record_type.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_refund
    on f._fivetran_synced::date = data_refund.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_refund_line_payment
    on f._fivetran_synced::date = data_refund_line_payment.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_revenue_async_operation
    on f._fivetran_synced::date = data_revenue_async_operation.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_revenue_transaction_error_log
    on f._fivetran_synced::date = data_revenue_transaction_error_log.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_sbqq_field_metadata_c
    on f._fivetran_synced::date = data_sbqq_field_metadata_c.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_sbqq_product_option_c
    on f._fivetran_synced::date = data_sbqq_product_option_c.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_sbqq_quote_c
    on f._fivetran_synced::date = data_sbqq_quote_c.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_sbqq_quote_line_c
    on f._fivetran_synced::date = data_sbqq_quote_line_c.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_sbqq_quote_line_group_c
    on f._fivetran_synced::date = data_sbqq_quote_line_group_c.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_sender_email_address
    on f._fivetran_synced::date = data_sender_email_address.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_service_and_training_request_c
    on f._fivetran_synced::date = data_service_and_training_request_c.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_service_and_training_request_feed
    on f._fivetran_synced::date = data_service_and_training_request_feed.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_service_and_training_request_history
    on f._fivetran_synced::date = data_service_and_training_request_history.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_setup_assistant_step
    on f._fivetran_synced::date = data_setup_assistant_step.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_sfdc_partner_sbscr_offer
    on f._fivetran_synced::date = data_sfdc_partner_sbscr_offer.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_sfdc_partner_sbscr_offer_history
    on f._fivetran_synced::date = data_sfdc_partner_sbscr_offer_history.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_sfdc_partner_sbscr_offer_item
    on f._fivetran_synced::date = data_sfdc_partner_sbscr_offer_item.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_slack_channel_related_record
    on f._fivetran_synced::date = data_slack_channel_related_record.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_state_profile_c
    on f._fivetran_synced::date = data_state_profile_c.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_switches_c
    on f._fivetran_synced::date = data_switches_c.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_team_c
    on f._fivetran_synced::date = data_team_c.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_team_feed
    on f._fivetran_synced::date = data_team_feed.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_team_history
    on f._fivetran_synced::date = data_team_history.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_team_member_c
    on f._fivetran_synced::date = data_team_member_c.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_team_member_feed
    on f._fivetran_synced::date = data_team_member_feed.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_team_member_history
    on f._fivetran_synced::date = data_team_member_history.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_time_slot
    on f._fivetran_synced::date = data_time_slot.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_time_slot_history
    on f._fivetran_synced::date = data_time_slot_history.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_training_session_c
    on f._fivetran_synced::date = data_training_session_c.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_training_session_feed
    on f._fivetran_synced::date = data_training_session_feed.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_unit_of_measure
    on f._fivetran_synced::date = data_unit_of_measure.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_unstructured_storage_space
    on f._fivetran_synced::date = data_unstructured_storage_space.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_user
    on f._fivetran_synced::date = data_user.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_user_history
    on f._fivetran_synced::date = data_user_history.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_user_prov_account
    on f._fivetran_synced::date = data_user_prov_account.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_user_prov_account_staging
    on f._fivetran_synced::date = data_user_prov_account_staging.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_user_prov_mock_target
    on f._fivetran_synced::date = data_user_prov_mock_target.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_user_provisioning_log
    on f._fivetran_synced::date = data_user_provisioning_log.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_user_provisioning_request
    on f._fivetran_synced::date = data_user_provisioning_request.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_user_role
    on f._fivetran_synced::date = data_user_role.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_video_call
    on f._fivetran_synced::date = data_video_call.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_video_call_feed
    on f._fivetran_synced::date = data_video_call_feed.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_video_call_participant
    on f._fivetran_synced::date = data_video_call_participant.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_video_call_recording
    on f._fivetran_synced::date = data_video_call_recording.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_voice_call_recording
    on f._fivetran_synced::date = data_voice_call_recording.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_voice_chnl_interaction_event
    on f._fivetran_synced::date = data_voice_chnl_interaction_event.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_voice_chnl_intrctn_dtl_event
    on f._fivetran_synced::date = data_voice_chnl_intrctn_dtl_event.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_web_link
    on f._fivetran_synced::date = data_web_link.max_fivetran_synced_date
group by all
/*==============================================================================================*/
/*====================================  HUBSPOT final queries ==================================*/
/*==============================================================================================*/
union all
select
    schema_name,
...
join data_association_type
    on f._fivetran_synced::date = data_association_type.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_company
    on f._fivetran_synced::date = data_company.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_company_company
    on f._fivetran_synced::date = data_company_company.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_contact_hubspot
    on f._fivetran_synced::date = data_contact_hubspot.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_contact_company
    on f._fivetran_synced::date = data_contact_company.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_deal
    on f._fivetran_synced::date = data_deal.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_deal_company
    on f._fivetran_synced::date = data_deal_company.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_deal_contact
    on f._fivetran_synced::date = data_deal_contact.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_deal_pipeline
    on f._fivetran_synced::date = data_deal_pipeline.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_deal_pipeline_stage
    on f._fivetran_synced::date = data_deal_pipeline_stage.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_deal_stage
    on f._fivetran_synced::date = data_deal_stage.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_invoice_hubspot
    on f._fivetran_synced::date = data_invoice_hubspot.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_invoice_company
    on f._fivetran_synced::date = data_invoice_company.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_invoice_contact
    on f._fivetran_synced::date = data_invoice_contact.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_invoice_deal
    on f._fivetran_synced::date = data_invoice_deal.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_invoice_line_item
    on f._fivetran_synced::date = data_invoice_line_item.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_line_item
    on f._fivetran_synced::date = data_line_item.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_line_item_deal
    on f._fivetran_synced::date = data_line_item_deal.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_payment_hubspot
    on f._fivetran_synced::date = data_payment_hubspot.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_payment_company
    on f._fivetran_synced::date = data_payment_company.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_payment_contact
    on f._fivetran_synced::date = data_payment_contact.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_payment_deal
    on f._fivetran_synced::date = data_payment_deal.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_payment_invoice
    on f._fivetran_synced::date = data_payment_invoice.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_payment_line_item
    on f._fivetran_synced::date = data_payment_line_item.max_fivetran_synced_date
group by all
union all
select
    schema_name,
...
join data_product
    on f._fivetran_synced::date = data_product.max_fivetran_synced_date
group by all
