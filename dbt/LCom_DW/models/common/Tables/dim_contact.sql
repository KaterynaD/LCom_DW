...
(
    select
isnull(r.id,'{{ var("default_varchar") }}') as contact_id, 
...
isnull(a.account_id,'{{ var("default_varchar") }}') as account_id,
isnull(a.sfdc_account_id,'{{ var("default_varchar") }}') as sfdc_account_id,
...
isnull(r.owner_id,'{{ var("default_varchar") }}') as owner_id, 
