...
and o.invoiced_date = '1900-01-01'
union all
select to_char(o.start_date,'yyyymm')::int mon_year, o.opportunity_id, 'Negative or Replacement' issue
from {{ ref('stg_arr_base') }} b
join {{ ref('fact_opportunity') }} o
on b.opportunity_id = o.opportunity_id
...
and o.invoiced_date = '1900-01-01'
union all
select to_char(o.start_date,'yyyymm')::int mon_year, o.opportunity_id, 'Won Start Date after End Date or missing' issue
from {{ ref('stg_arr_base') }} b
join {{ ref('fact_opportunity') }} o
on b.opportunity_id = o.opportunity_id
where  
...
union all
select to_char(ro.start_date,'yyyymm')::int mon_year, ro.opportunity_id, 'Won Renewal Start or End Date before Parent Start or End Date' issue
from {{ ref('stg_arr_base') }} b
join {{ ref('fact_opportunity') }} o
on b.opportunity_id = o.opportunity_id
...
union all
select to_char(o.start_date,'yyyymm')::int mon_year, o.opportunity_id, 'Lost Start Date after End Date or missing' issue
from {{ ref('stg_arr_base') }} b
join {{ ref('fact_opportunity') }} o
on b.opportunity_id = o.opportunity_id
where  
...
and o.start_date >= o.end_date
union all
select to_char(ro.start_date,'yyyymm')::int mon_year, ro.opportunity_id, 'Lost Renewal Start Date before Parent Start or End Date (Won)' issue
from {{ ref('stg_arr_base') }} b
join {{ ref('fact_opportunity') }} o
on b.opportunity_id = o.opportunity_id
join {{ ref('fact_opportunity') }} ro
...
,final_data as (
select 
to_char(o.start_date,'yyyymm')::int mon_year, o.opportunity_id, 'Other' as issue
from
(
select opportunity_id
from other
...
on b.opportunity_id = o.opportunity_id
union all
select mon_year, opportunity_id, issue from data
)
select distinct
mon_year::int,
