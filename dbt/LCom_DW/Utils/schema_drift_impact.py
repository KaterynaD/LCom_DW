...
INPUTS: List[Dict[str, Any]] = [
    {"source": "source.LCom_DW.fivetran_salesforce_quickstart.account", "source_column": "alt_phone_c"},
    {"source": "source.LCom_DW.fivetran_salesforce_quickstart.account", "source_column": "billing_state_code"},
    {"source": "source.LCom_DW.fivetran_salesforce_quickstart.account", "source_column": "asdasdasd"},
    {"source": "source.LCom_DW.dbo.learning_object", "source_column": "learning_object_name"},
    {"source": "source.LCom_DW.dbo.standard", "source_column": "is_cipa_cyberbullying"},
]
